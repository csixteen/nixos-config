...
(add-to-list 'load-path "/home/pmpro/.emacs.d/elisp")
...
(custom-set-variables
 ...
 '(custom-safe-themes
   '("fdaf036ac62069f9b785ad2486b8106fb704b7c898d73ff7f66dc657523349d3"
     ...
     "3b51d25e68bf76cedd8dffe458f9cf827e9bc735fae3a0c46761de1e6ac00fdf"
 ...
 '(hl-bg-colors
   '("#4c4536" "#4b4136" "#504341" "#4d3936" "#3b313d" "#41434a"
     "#3b473c" "#3d464c"))
 '(hl-fg-colors
   '("#2a2a29" "#2a2a29" "#2a2a29" "#2a2a29" "#2a2a29" "#2a2a29"
     "#2a2a29" "#2a2a29"))
 ...
 '(rustic-ansi-faces
   ["#272822" "#E74C3C" "#A6E22E" "#E6DB74" "#268bd2" "#F92660" "#66D9EF"
    "#F8F8F2"])
 ...
 '(warning-suppress-types
   '(((defvaralias losing-value lsp-eldoc-hook)) (use-package)))
 '(weechat-color-list
   '(unspecified "#2a2a29" "#2f2f2e" "#504341" "#ffb4ac" "#3d464c"
                 "#8ac6f2" "#4c4536" "#e5c06d" "#41434a" "#a4b5e6"
                 "#4d3936" "#e5786d" "#3b473c" "#7ec98f" "#8d8b86"
                 "#74736f"))
 '(window-divider-mode nil)
 '(xterm-color-names
   ["#2f2f2e" "#ffb4ac" "#8ac6f2" "#e5c06d" "#a4b5e6" "#e5786d" "#7ec98f"
    "#e8e5db"])
 '(xterm-color-names-bright
   ["#2a2a29" "#ddaa6f" "#6a6a65" "#74736f" "#8d8b86" "#834c98" "#999891"
    "#f6f3e8"]))
